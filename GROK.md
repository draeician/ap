...
1. `AGENTS.md`
2. `project_spec.md`
3. `DEV_NOTES.md` when metadata atoms/switches are involved
4. The active task under `.crules/tasks/wip/` if one exists
5. `.crules/modes/CODER.md` or `MANAGER.md` depending on the work
